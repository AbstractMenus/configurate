...
public class ConfigurationTransformationTest {
    ...
    public void testComparator() {
        ...
        final TransformAction action = new TransformAction() {
            @Nullable
            @Override
            public Object[] visitPath(@NonNull ConfigurationTransformation.NodePath inputPath, @NonNull ConfigurationNode valueAtPath) {
    ...
    public void testWildcardMatching() {
        ...
        final TransformAction action = new TransformAction() {
            @Nullable
            @Override
            public Object[] visitPath(@NonNull ConfigurationTransformation.NodePath path, @NonNull ConfigurationNode valueAtPath) {
